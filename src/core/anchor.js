// *
// A little modification to ban the chinese id that new version anchor-js generated.
// (regexp and the idList generator)
// --------------------------------------------------------------------------------
	...
	function AnchorJS(options) {
		...
		this.add = function (selector) {
			...
			for (i = 0; i < elements.length; i++) {
				...
				if (elements[i].hasAttribute('id')) {
					...
					if (!tidyText || !Number.isNaN(Number(tidyText))) {
						tidyText = 'section';
					}
		...
		this.urlify = function (text) {
			...
			urlText = text.trim()                               // "⚡⚡ Don't forget: URL fragments should be i18n-friendly, hyphenated, short, and clean."
				.replace(/[^\w\s-]/gi, "")				// "⚡⚡ Don't forget: URL fragments should be i18n-friendly, hyphenated, short, and clean."
